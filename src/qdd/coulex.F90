...
! include BLOCK: xkgrid
  ...
  REAL(DP), ALLOCATABLE, PRIVATE ::fftax(:), fftay(:), fftb(:, :)
#endif
...
#if(extended)
! akv2=ffta 
! Since akv2 and ffta are pointers to arrays, I am not sure this is a 
! valid expression. It generates segfaults during runtime on certain 
! combinations of Intel CPUs and Intel Fortran versions.
#endif
    DO i3 = 1, nzi
      DO i2 = 1, nyi
        DO i1 = 1, nxi
