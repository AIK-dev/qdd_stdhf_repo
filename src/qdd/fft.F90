...
! initialitze 3D plans, optionally for OpenMP
    ...
    IF (nxini == 0) THEN
      IF (myn == 0) THEN
        pforwx(0) = fftw_plan_dft_1d(nx2, fftax(:,0), fftax(:,0), FFTW_FORWARD, FFTW_planflag)
        pbackx(0) = fftw_plan_dft_1d(nx2, fftax(:,0), fftax(:,0), FFTW_BACKWARD, FFTW_planflag)
        nxini = nx2
#if(fftwnomkl)
        wisdomtest = fftw_export_wisdom_to_filename(C_CHAR_'wisdom_fftw.dat'//C_NULL_CHAR)
#endif
    ...
    IF (nyini == 0) THEN
      IF (myn == 0) THEN
        pforwy(0) = fftw_plan_dft_1d(ny2, fftay(:,0), fftay(:,0), FFTW_FORWARD, FFTW_planflag)
        pbacky(0) = fftw_plan_dft_1d(ny2, fftay(:,0), fftay(:,0), FFTW_BACKWARD, FFTW_planflag)
        nyini = ny2
#if(fftwnomkl)
        wisdomtest = fftw_export_wisdom_to_filename(C_CHAR_'wisdom_fftw.dat'//C_NULL_CHAR)
#endif
...
!        pforwz = fftw_plan_dft_1d(nz2, fftb(1, nx2), fftb(1, nx2), FFTW_FORWARD, FFTW_planflag)
!        pbackz = fftw_plan_dft_1d(nz2, fftb(1, nx2), fftb(1, nx2), FFTW_BACKWARD, FFTW_planflag)
        pforwz(0) = fftw_plan_dft_1d(nz2, fftaz(:,0), fftaz(:,0), FFTW_FORWARD, FFTW_planflag)
        pbackz(0) = fftw_plan_dft_1d(nz2, fftaz(:,0), fftaz(:,0), FFTW_BACKWARD, FFTW_planflag)
        nzini = nz2
#if(fftwnomkl)
        wisdomtest = fftw_export_wisdom_to_filename(C_CHAR_'wisdom_fftw.dat'//C_NULL_CHAR)
#endif
